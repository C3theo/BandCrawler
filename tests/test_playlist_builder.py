...
#             TODO: Make work - have to currently use web browser
#             might not me necessary to test
#         """
...
#         self.assertTrue(self.ply_manager.client_mgr._is_scope_subset(self.ply_manager.scope,
#             token_info['scope']))
