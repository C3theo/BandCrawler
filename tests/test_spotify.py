...
test_data = [(token_expired, False), (token_current, True)]


@pytest.mark.parametrize('test_input, expectation', test_data)
def test_token_auth(test_input, expectation):
    """Test token auth."""
...
# testing exceptino handling with spotipy oauth
